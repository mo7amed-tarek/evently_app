...
class _CreateEventScreenState extends State<CreateEventScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          StringsManager.create_event.tr(),
            ...
            child: Column(
              ...
              children: [
                ...
                CustomField(
                  ...
                  hint: StringsManager.event_title.tr(),
                ...
                CustomField(
                  ...
                  hint: StringsManager.event_desc.tr(),
                  prefixpath: AssetsManager.edit,
                        ...
                        Expanded(
                          child: Text(
                            selectedLocation != null
                                ...
                                : StringsManager.choose_event_location.tr(),
                            style: TextStyle(
                              color: ColorManager.blue,
                              fontSize: 14.sp,
                ...
                SizedBox(
                  width: double.infinity,
                  child: CustomButton(
                    title: StringsManager.add_event.tr(),
                    onClick: () async {
                      if (formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          Navigator.pop(context); // Close CreateEventScreen
                          DialogUtils.showtoast(
                            StringsManager.event_added.tr(),
                          );
                        } catch (e) {
